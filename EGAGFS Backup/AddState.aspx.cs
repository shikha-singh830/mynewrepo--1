...
namespace EGAGFS
{
    public partial class AddState : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Sp_AddViewState", con);
            cmd.CommandType = CommandType.StoredProcedure;
            //int State_Id= Convert.ToInt32(@"{State_Id" .Values[0]);
            // cmd.Parameters.AddWithValue("@State_Id", "Add");
            cmd.Parameters.AddWithValue("@State_Code", txtcode.Text);
            cmd.Parameters.AddWithValue("@State_Name", txtname.Text);
